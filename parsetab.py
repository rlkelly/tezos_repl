...
_lr_productions = [
  ...
  ('TYPE -> NAT','TYPE',1,'p_statement_type','main.py',523),
  ('TYPE -> STRING','TYPE',1,'p_statement_type','main.py',524),
  ('TYPE -> INT','TYPE',1,'p_statement_type','main.py',525),
  ('TYPE -> BOOL','TYPE',1,'p_statement_type','main.py',526),
  ('TYPE -> BYTES','TYPE',1,'p_statement_type','main.py',527),
  ('TYPE -> LPARENS LPAIR TYPE TYPE RPARENS','TYPE',5,'p_statement_type','main.py',528),
  ('stmt -> PUSH TYPE value','stmt',3,'p_statement_push','main.py',543),
  ('stmt -> FAILWITH','stmt',1,'p_statement_failwith','main.py',567),
]
